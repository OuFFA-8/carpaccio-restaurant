...
export class MenuDetails implements OnInit {
  ...
  fullMenu = [
    ...
    {
      id: 'breakfast-carpaccio',
      category: 'افطارات / Colazione',
    ...
    {
      id: 'soup-hamousta',
      category: 'شوربات // Zuppa Signature',
      it: 'Kibbeh Hamousta',
    ...
    // --- المقبلات الباردة (Antipasti Freddi) ---
    {
      ...
      category: 'المقبلات الباردة // Antipasti Freddi',
    ...
    // --- المقبلات الساخنة (Antipasti Caldi) ---
    {
      ...
      category: 'المقبلات الساخنة // Antipasti Caldi',
    ...
    {
      id: 'pasta-ravioli',
      category: 'المطبخ الإيطالي // Cucina Italiana',
    ...
    // --- الأطباق الرئيسية (Piatti Principali) ---
    {
      ...
      category: 'الأطباق الرئيسية // Piatti Principali',
    ...
    // --- مطبخ الشيف (Chef's Signature Kitchen) ---
    {
      ...
      category: "مطبخ الشيف // Chef's Signature",
    ...
    {
      id: 'fish-barramundi',
      category: 'أطباق السمك والبحر // Pesce and More',
    ...
    // --- وجبات الأطفال (Menu per Bambini) ---
    {
      ...
      category: 'وجبات الأطفال // Menu per Bambini',
